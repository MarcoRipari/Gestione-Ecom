...
async def test_debug():
    ...
    async with aiohttp.ClientSession() as session:
        url1 = "https://drive.google.com/uc?export=download&id=1GVjmhKEPNQTiFfnAuDM-NsCJEC2DLBM2"
        url2 = "https://drive.google.com/uc?export=download&id=1lLyYfJmbRxR7aRVdKdt1Ev78SUHALi0d"
